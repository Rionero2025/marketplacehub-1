# Marketplace Hub — Public Cloud v273

Repository cloud pulito del Marketplace Hub, derivato dalla release applicativa v271 e predisposto per esecuzione online con **Streamlit + PostgreSQL + Docker + Render**.
